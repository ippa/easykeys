...
declare class Easykeys {
    private pressedKeys;
    private prevPressedKeys;
    private downCallbacks;
    private downOnceCallbacks;
    private upCallbacks;
    preventDefaultForKeycodes: string[];
    debug: boolean;
    constructor(args?: Args);
    down: (key: KeyboardEventKey | KeyboardEventKey[] | KeyboardEventKeyWithModifier | KeyboardEventKeyWithModifier[], callback: () => void) => void;
    downWithRepeat: (key: KeyboardEventKey | KeyboardEventKey[], callback: () => void) => void;
    up: (key: KeyboardEventKey | KeyboardEventKey[] | KeyboardEventKeyWithModifier | KeyboardEventKeyWithModifier[], callback: () => void) => void;
    ...
    preventDefaultFor(key: KeyboardEventKey | KeyboardEventKey[]): void;
    private onKeyDown;
    private onKeyUp;
    private handleKey;
}
declare const easykeys: Easykeys;
export { easykeys };
